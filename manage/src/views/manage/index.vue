<template>
	<div class="manage tc">
		...
		<div class="input-area" v-show="showAdd">
			<input type="text" name="text" placeholder="please enter name" v-model="nameValue">
		...
		<div class="wrap" v-show="showEdit">
			<div class="content">
				<input type="text" name="" placeholder="请输入新姓名" v-model="newName">
